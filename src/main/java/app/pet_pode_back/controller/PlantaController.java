...
public class PlantaController {
 ...
 /*@GetMapping(value={"consulta-nomePopular"},produces = { MediaType.APPLICATION_JSON_VALUE })
    public ResponseEntity<List<Plantas>> get(@RequestParam("nomePopular") String nomePopular) {
    ...
    public ResponseEntity<List<Plantas>> get(@RequestParam("nomeCientifico") String nomeCientifico) {
